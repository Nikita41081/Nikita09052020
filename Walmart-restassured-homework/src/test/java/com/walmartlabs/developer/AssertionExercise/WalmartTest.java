package com.walmartlabs.developer.AssertionExercise;/*
Created 
By Nikita
*/
...
public class WalmartTest extends TestBase {
    ...
    public void test004() {
        ...
        given()
                ...
                .get("/search")
                .then()
                .body("items.name", hasItems("Apple iPod touch 7th Generation 32GB - Space Gray (New Model)", "Apple iPod Touch 6th Generation 32GB Refurbished"));
